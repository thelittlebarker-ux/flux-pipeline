...
function tripEcoScore(trip) {
  const { distanceKm, energyUsedKwh, durationMin, events = {} } = trip;
  if (!distanceKm || distanceKm <= 0) return 0;

  // 1. Efficiency component (0-70). Lower kWh/100km is better.
  const consumption = (energyUsedKwh / distanceKm) * 100;
