...
const BADGES = [
  { id: 'first-drive', name: 'First Spark', icon: 'bolt', desc: 'Logged your first electric trip', test: (s) => s.tripCount >= 1 },
  { id: 'eco-ace', name: 'Eco Ace', icon: 'leaf', desc: 'Averaged an A grade across 10+ trips', test: (s) => s.tripCount >= 10 && s.avgEco >= 80 },
  { id: 'ton-saver', name: 'Tonne Saver', icon: 'globe', desc: 'Avoided 1,000 kg of CO₂', test: (s) => s.totalCo2 >= 1000 },
  { id: 'streak-7', name: 'Week Warrior', icon: 'flame', desc: '7-day driving streak', test: (s) => s.streak >= 7 },
  { id: 'streak-30', name: 'Habit Master', icon: 'trophy', desc: '30-day driving streak', test: (s) => s.streak >= 30 },
  { id: 'battery-guardian', name: 'Battery Guardian', icon: 'shield', desc: 'Battery care score above 90', test: (s) => s.careScore >= 90 },
  { id: 'road-tripper', name: 'Road Tripper', icon: 'road', desc: 'Driven 5,000 electric km', test: (s) => s.totalDistance >= 5000 },
  { id: 'forest-maker', name: 'Forest Maker', icon: 'tree', desc: 'Offset equal to 100 trees/year', test: (s) => s.totalCo2 / C.CO2_PER_TREE_YEAR >= 100 },
];
...
const REWARD_CATALOG = [
  { id: 'coffee-voucher', name: 'Coffee Voucher', desc: 'Free coffee at partner cafés', cost: 150, category: 'Lifestyle', icon: 'coffee' },
  { id: 'car-wash', name: 'Premium Car Wash', desc: 'Complimentary premium car wash', cost: 300, category: 'Service', icon: 'droplet' },
  { id: 'charge-session', name: 'Free Charging Session', desc: '1 hour of free chargEV fast charging', cost: 500, category: 'Charging', icon: 'plug' },
  { id: 'tree-plant', name: 'Plant 5 Trees', desc: '5 trees planted in your name', cost: 800, category: 'Impact', icon: 'tree' },
  { id: 'service-credit', name: '$10 Service Credit', desc: 'Credit toward vehicle maintenance', cost: 1000, category: 'Service', icon: 'wrench' },
  { id: 'carbon-offset', name: 'Offset 1 Tonne CO₂', desc: 'Certified carbon offset in your name', cost: 1200, category: 'Impact', icon: 'globe' },
  { id: 'charge-credit-25', name: '$25 Charging Credit', desc: 'Credit on the public charging network', cost: 2000, category: 'Charging', icon: 'bolt' },
  { id: 'insurance-discount', name: '5% Insurance Discount', desc: 'Voucher toward your EV insurance renewal', cost: 5000, category: 'Premium', icon: 'shield' },
];
