...
// Redeemable rewards catalogue — the tangible benefit that makes points worth chasing.
const REWARD_CATALOG = [
  { id: 'charge-credit-10', name: '$10 Public Charging Credit', cost: 1000, category: 'Charging', icon: '🔌' },
  { id: 'charge-credit-25', name: '$25 Public Charging Credit', cost: 2300, category: 'Charging', icon: '🔌' },
  { id: 'free-detail', name: 'Free EV Detailing', cost: 3500, category: 'Service', icon: '🧽' },
  { id: 'tyre-check', name: 'Free Tyre & Brake Check', cost: 1500, category: 'Service', icon: '🛞' },
  { id: 'tree-plant', name: 'Plant 5 Trees in Your Name', cost: 800, category: 'Impact', icon: '🌳' },
  { id: 'carbon-offset', name: 'Offset 1 Tonne CO₂', cost: 1200, category: 'Impact', icon: '🌍' },
  { id: 'priority-charge', name: '1 Month Priority Charging', cost: 4000, category: 'Premium', icon: '⭐' },
  { id: 'insurance-discount', name: '5% Insurance Discount Voucher', cost: 6000, category: 'Premium', icon: '🛡️' },
];
