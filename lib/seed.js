...
function seed() {
  const users = [
    { id: 'u_you', name: 'You', handle: 'you', joinedAt: '2024-09-01', isPrimary: true },
    { id: 'u_maya', name: 'Maya Chen', handle: 'maya', joinedAt: '2024-06-10' },
    { id: 'u_omar', name: 'Omar Haddad', handle: 'omar', joinedAt: '2024-07-22' },
    { id: 'u_lena', name: 'Lena Fischer', handle: 'lena', joinedAt: '2024-08-05' },
    { id: 'u_raj', name: 'Raj Patel', handle: 'raj', joinedAt: '2024-05-18' },
    { id: 'u_sofia', name: 'Sofia Rossi', handle: 'sofia', joinedAt: '2024-10-02' },
  ].map((u) => ({
    ...u,
    points: 0,
    lifetimePoints: 0,
